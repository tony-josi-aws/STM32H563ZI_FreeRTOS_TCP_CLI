...
int main(void)
{
  ...
  while (1)
  {
	  #define TEST_CANDIDATE_0_STR "Bare metal test!!!\n\r"
	  HAL_UART_Transmit( &( huart3 ), ( const uint8_t * )TEST_CANDIDATE_0_STR, strlen( TEST_CANDIDATE_0_STR ), 1000 );
	  HAL_Delay( 2000 );
  }
#endif /* TEST_CANDIDATE_0 */
